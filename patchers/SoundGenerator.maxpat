...
,
									"fileref" : 									{
										"name" : "Tunefish4",
										"filename" : "Tunefish4.maxsnap",
										"filepath" : "D:/MCT_master/THESIS/agent_music_improviser/data",
										"filepos" : -1,
										"snapshotfileid" : "611d40536a93609e24c33ac2d57048e4"
									}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 996.0, 292.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 996.0, 338.0, 47.0, 22.0 ],
					"text" : "pack i f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 996.0, 372.0, 81.0, 22.0 ],
					"text" : "volume $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1003.0, 98.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1003.0, 137.0, 67.0, 22.0 ],
					"text" : "volume 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1003.0, 176.0, 78.0, 22.0 ],
					"text" : "route volume"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 336.5, 263.0, 66.0, 146.0 ],
					"text" : "write C:/Users/Pedro/Documents/MCT_Master/THESIS/agent_music_improviser/data/soundgen0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 425.5, 263.0, 66.0, 146.0 ],
					"text" : "read C:/Users/Pedro/Documents/MCT_Master/THESIS/agent_music_improviser/data/soundgen0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 372.5, 167.0, 91.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 456.5, 224.0, 49.0, 22.0 ],
					"text" : "read $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 522.5, 332.0, 173.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 522.5, 287.0, 79.0, 22.0 ],
					"text" : "regexp (.*/).*/"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 522.5, 207.0, 34.0, 22.0 ],
					"text" : "path"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 522.5, 246.0, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 367.5, 224.0, 51.0, 22.0 ],
					"text" : "write $1"
				}
