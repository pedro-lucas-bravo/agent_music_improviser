...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 606.0, 817.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 676.0, 774.0, 29.5, 22.0 ],
					"text" : "t l b"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 597.5, 904.0, 55.0, 34.0 ],
					"text" : "Source number"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 610.0, 859.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 504.0, 908.0, 54.0, 20.0 ],
					"text" : "Signal"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 922.5, 904.0, 150.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 802.5, 911.0, 107.0, 20.0 ],
					"text" : "Spat Messages",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 678.0, 904.0, 101.0, 34.0 ],
					"presentation_linecount" : 2,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 841.0, 859.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 610.0, 763.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					"comment" : "Position X Y Z milimiters",
					"id" : "obj-31",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 705.0, 859.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 972.5, 859.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 504.0, 863.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 31.0, 523.0, 150.0, 34.0 ],
					"text" : "note ID(trackId) List(pictch velocity)"
				}
...
,
					"snapshot" : 					{
						...
						"embed" : 1,
						"snapshot" : 						{
							"pluginname" : "Tunefish4.vstinfo",
							"plugindisplayname" : "Tunefish4",
							"pluginsavedname" : "D:/VST/VST64/Tunefish/Tunefish4.dll",
...
,
									"fileref" : 									{
										"name" : "Tunefish4",
										"filename" : "Tunefish4_20220412.maxsnap",
										"filepath" : "~/Documents/MCT_Master/THESIS/agent_music_improviser/data",
										"filepos" : -1,
										"snapshotfileid" : "5a059a0e221fc0aa085ed0baf49eb1c8"
									}
...
,
					"text" : "vst~ D:/VST/VST64/Tunefish/Tunefish4.dll",
					"varname" : "vst~[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1072.5, 0.0, 97.0, 34.0 ],
					"text" : "Synthe Control Msgs"
				}

			}
, 			{
				"box" : 				{
					"comment" : "Synthe Control Msgs",
					"id" : "obj-33",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1099.5, 38.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					"comment" : "note ID(trackId) List(pictch velocity)",
					"id" : "obj-11",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 55.0, 475.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 71.166666666666686, 325.0, 47.0, 22.0 ],
					"text" : "unpack"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 35.666666666666686, 324.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.666666666666686, 372.0, 52.0, 22.0 ],
					"text" : "pack i i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.666666666666686, 414.0, 82.0, 22.0 ],
					"text" : "note $1 $2 $3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 917.5, 0.0, 150.0, 34.0 ],
					"text" : "Mode: 1 binaural, 2 Ambisonic"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 943.5, 38.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 797.5, 7.0, 107.0, 20.0 ],
					"text" : "Spat Messages",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 836.0, 29.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 673.0, 0.0, 101.0, 34.0 ],
					"text" : "Position X Y Z in millimeters"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "Tunefish4_20220412.maxsnap",
				"bootpath" : "~/Documents/MCT_Master/THESIS/agent_music_improviser/data",
